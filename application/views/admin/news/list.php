    ...
    <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="d-flex align-items-end row">
                      <div class="col-sm-12">
                        <!-- Bordered Table -->
              <div class="card">
                <h5 class="card-header">Courses List
                    <a href="<?php echo base_url('a_news_create');?>"><button type="button" class="btn btn-success" style="float:right;">Create</button>
                    </a>
                    </h5>
                <div class="card-body">
                    ...
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        ...
                        <?php $sira = 0; foreach($get_all as $items){ $sira++; ?>
                          ...
                          <td><?php echo $items->n_price_az;?></td>
                          <td><?php echo $items->n_month_az;?></td>
                          <td><?php echo $items->n_times_az;?></td>
                          <td><?php echo $items->n_hour_az;?></td>
                          <td>
                          ...
                          <?php if($items->n_file_ext == '.mp3'){ ?>
                            ...
                            <?php }else{ ?>
                                <a target="_blank" href="<?php echo base_url("uploads/news/").$items->n_file; ?>">
                                  <img width="50" height="50" style="object-fit:cover;" src="<?php echo base_url("uploads/news/").$items->n_file; ?>" alt="">
                                </a>
                            <?php }?>
                          ...
                          <td>
                              ...
                              <i class="bx bx-edit-alt"></i>
                                ...
                                <a onclick="return confirm('Are you sure want to delete this news?')"href="<?php echo base_url('a_deleteNews/'.$items->n_id);?>">
                                <button
                                type="button"
