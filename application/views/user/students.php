        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <h1 class="display-3 text-white animated slideInDown"><?php echo $this->lang->line('Students'); ?></h1>
    ...
    <div class="container-xxl py-5 category">
        ...
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                <h6 class="section-title bg-white text-center text-primary px-3"><?php echo $this->lang->line('students2'); ?></h6>
                <br>
                <br>
                <br>
            <div class="row g-3">
                <div class="col-lg-12 col-md-12">
                    <div class="row g-3">
                        ...
                        <div class="col-lg-4 col-md-4 wow zoomIn" data-wow-delay="0.1s">
                            <a class="position-relative d-block overflow-hidden" href="<?php echo base_url('singleStudent/'.$item['s_id']); ?>">
                                <?php if($item['s_file']){ ?>
                                    <img  style="width:100%!important; height:300px !important; object-fit:cover!important;" class="img-fluid" src="<?php echo base_url('uploads/students/'.$item['s_file']); ?>" alt="">
                                <?php }else{ ?>
